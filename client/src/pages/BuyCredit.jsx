...
const BuyCredit = () => {
  ...
  return (
    ...
    >
      ...
      <h2 className="font-semibold flex-wrap text-xl sm:text-2xl">This credits are completly <span className="text-green-600">FREE</span>  you can add it... the payment is only testing purpose you can buy dummy... your amount not diduct from your account</h2>

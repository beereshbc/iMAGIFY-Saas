...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p className="flex animate-shake animate-thrice font-md text-blue-700 cursor-pointer"><span class="[&>svg]:h-5 [&>svg]:w-5">
          <svg
        ...
        </span><a href="/" alt={"www.linkedin.com/in/beereshkumar-b-c-004397341"}>: Beereshkumar B C</a></p>

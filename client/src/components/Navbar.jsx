...
const Navbar = () => {
  const { setShowLogin, user, credits, logout } = useContext(AppContext);
        ...
        {user ? (
          ...
          <div className="flex items-center gap-2 sm:gap-5">
            ...
            <button
              ...
              className="bg-zinc-800 text-white px-7 sm:px-10 py-2 text-sm rounded-full"
            >
              Login
            </button>
          </div>
